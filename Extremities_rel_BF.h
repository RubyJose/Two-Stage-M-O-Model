void Extremities_rel_BF(float min_max, int st_yr,int end_yr,int x_day,float Release[][366],float xday_min_outf[],float pre_xday_min[], 
						float Nexp_Month[], float Nobs_Month[],float* HA_middle){
