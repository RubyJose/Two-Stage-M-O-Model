void Extremities_inf_BF(float min_max, int st_yr,int end_yr,int x_day,float Inflow[][366],float xday_min_inf[], float pre_xday_min[],  
						float Nexp_Month[] ){
...
// expected number of years falling within the low, middle and high alteration categories of RVA
